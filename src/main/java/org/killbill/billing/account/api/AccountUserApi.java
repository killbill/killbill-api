...
public interface AccountUserApi extends KillbillApi {
     ...
     */
    List<AuditLogWithHistory> getEmailAuditLogsWithHistoryForId(UUID accountId, UUID accountEmailId, AuditLevel auditLevel, TenantContext context) throws AccountApiException;
